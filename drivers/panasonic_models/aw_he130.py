...
AW-HR140). `knee` has 3 valid values (Off/Manual/Auto); `knee_manual`/
`knee_auto` are mutually exclusive toggles (`exclusive_with`, see
core/application.py::apply_button_action()). No iris-F-number support.
"""
